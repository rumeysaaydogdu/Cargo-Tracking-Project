...
CREATE TABLE `sube` (
  `SubeID` int NOT NULL AUTO_INCREMENT,
  `SubeTelefon` varchar(45) NOT NULL,
  `SubeAdres` varchar(100) DEFAULT NULL,
  `SubeAd` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`SubeID`,`SubeTelefon`)
...
INSERT INTO `sube` VALUES (21,'6423642','izmir','izmirkargo'),(22,'6424642','corlu','corlukargo');
